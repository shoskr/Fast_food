...
<html>
    ...
    <body>
        ...
        $sql = $conexion->query("select detalle_venta.iddetalle_venta, detalle_venta.`venta_Idventas`, producto.nombre, detalle_venta.cantidad "
                ...
                . "where detalle_venta.estado = 1 and termino = 0;");
        ?>
        <div class=" row">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading text-center">
                        <div style="background-color: appworkspace"> 
                            ...
                            <form action="procesoentrega.php" method="post">
                                <table class="table" style="background-color: whitesmoke">
                                    <tr>
                                        <td colspan="4" style="text-align: center">Entrega Productos</td>
                                    </tr>
                                    <tr>
                                        <td> Producto </td>
                                        <td> Nº Venta </td>
                                    ...
                                    ?>
                                    <tr>
                                        <td><input type="submit" id="btnTerminado" value="Producto Entragado"/></td>
                                    </tr>
                                </table>
